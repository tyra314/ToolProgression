...
public class CommonProxy
{
    ...
    public void preInit(FMLPreInitializationEvent e)
    {
        ...
        mining_level_config =
                new Configuration(new File(directory.getPath(), "tool_progression/mining_level_names.cfg"));
        block_overwrites_config =
                new Configuration(new File(directory.getPath(), "tool_progression/block_overwrites.cfg"));
        tool_overwrites_config =
                new Configuration(new File(directory.getPath(), "tool_progression/tool_overwrites.cfg"));
        mat_overwrites_config =
                new Configuration(new File(directory.getPath(), "tool_progression/materials_overwrites.cfg"));
        ...
        if (ConfigHandler.generate_dev_output)
        {
            ...
            mats_config = new Configuration(new File(directory.getPath(), "tool_progression/materials.cfg"));
    ...
    public void postInit(@SuppressWarnings("unused") FMLPostInitializationEvent e)
    {
        ...
        ConfigHandler.readOverwriteConfig();
